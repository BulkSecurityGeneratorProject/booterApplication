package de.orgname.application.config;
...
@Configuration
@EnableJpaRepositories("de.orgname.application.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("de.orgname.application.repository.search")
